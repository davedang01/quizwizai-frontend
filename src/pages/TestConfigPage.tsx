...
export default function TestConfigPage() {
  ...
  const handleGenerateTest = async () => {
    ...
    // iOS Safari blocks window.open() called after any await — must open synchronously
    const printWindow = (outputType === 'print-pdf' || outputType === 'email-pdf')
      ? window.open('', '_blank')
      : null
    ...
    try {
      ...
      if (outputType === 'in-app') {
        ...
        // printWindow was opened synchronously above to satisfy iOS Safari's popup policy
        if (printWindow) {
